        ...
        <div class="main-content">
                        ...
                        <form id="hospital-form">
                            <div class="row">
                                ...
                                <div class="form-group w-49">
                                    ...
                                    <input type="text" id="hospital-address" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group w-49">
                                        <label for="hospital-city">City</label>
                                        <input type="text" id="hospital-city" class="form-control" required>
                                </div>
                                <div class="form-group w-49">
                                        <label for="hospital-rating">Rating</label>
                                        <input type="number" id="hospital-rating" class="form-control" min="1" max="5" step="0.1" required>
                                </div>
                           </div>
                        ...
                        <form id="doctor-form">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group w-49">
                                    ...
                                    <input type="file" id="image" name="image" name="image">
                                </div>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('#values_faq-btn').click(function (e) {
                        e.preventDefault();
                        addValue2('faq');
                    });
                    ...
                    $('#values_schedule-btn').click(function (e) {
                        e.preventDefault();
                        addValue2('schedule');
                    });
                    ...
                    $('#doctor-form').submit(async function (e) {
                        ...
                        try {
                            fetch('/sample/admin/handle_post', {method: 'POST',
                                body: formData,
                            })
